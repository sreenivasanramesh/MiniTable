...
/**
 * All the relational operators and access methods are iterators. Used only for maps. (instead of tuples)
 */
public abstract class MapIterator implements Flags {
    ...
    private PageId newPage(Page page, int num) // num is number of pages
            throws IteratorBMException {
